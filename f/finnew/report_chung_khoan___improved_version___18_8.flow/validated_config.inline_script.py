...
def generate_datetime_png_key(base_name: str = "stock_summary_report") -> str:
    """Generate Excel key with datetime stamp"""
    now = datetime.now()
    date_str = now.strftime("%Y%m%d")
    # time_str = now.strftime("%H%M%S")
    return f"{base_name}_{date_str}.png"

def generate_datetime_html_key(base_name: str = "stock_summary_report") -> str:
    """Generate Excel key with datetime stamp"""
    now = datetime.now()
    date_str = now.strftime("%Y%m%d")
    # time_str = now.strftime("%H%M%S")
...
def main(
    ...
    png_key = generate_datetime_png_key(base_name)
    html_key = generate_datetime_html_key(base_name)
